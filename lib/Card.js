...
var Card = function (_React$Component) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['title', 'header', 'footer', 'className', 'textClassName', 'actions', 'reveal', 'children']);
...
Card.propTypes = {
  ...
  caption: _react2.default.PropTypes.element,
