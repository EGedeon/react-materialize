...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function renderIndicator() {
      ...
      return _react2.default.createElement('span', { className: 'indicator' });
    }
  }, {
    key: 'render',
          ...
          _react2.default.createElement(
            ...
            _react2.default.Children.map(children, function (child, idx) {
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  _extends(_defineProperty({ href: target, className: active || defaultValue === idx ? 'active' : '' }, 'className', active || defaultValue === idx ? 'active' : ''), disabled ? {} : { onClick: _this2._onSelect.bind(_this2, idx) }),
                  title
                )
              );
            })
